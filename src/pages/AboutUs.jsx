...
function AboutUs() {
  ...
  return (
    <>
    <ToastNotification content="Error" type="error"/>
      <div className="md:pt-24 px-4 sm:px-6 lg:px-8 pt-24">
        ...
        <div className="mb-8 p-6 border rounded-lg bg-gray-900 text-white shadow-md hover:shadow-lg transition-shadow duration-300">
          ...
          <ul className="list-disc list-inside">
            <li>
              Provide nutritious meals to families and individuals in need.
            </li>
        ...
        <div className="mb-8 p-6 border rounded-lg bg-gray-900 text-white shadow-md hover:shadow-lg transition-shadow duration-300">
          ...
          <p>
            You can make a difference! Whether you’re interested in donating
            food, volunteering your time, or partnering with us, your support is
