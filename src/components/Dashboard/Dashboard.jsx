  ...
  return (
    <div className="bg-gray-900 min-h-screen flex flex-col items-center md:pt-24 px-4 pb-10 sm:px-6 lg:px-8 pt-24">
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full md:max-w-3xl">
        <Link className="bg-gray-800 p-6 md:p-10 rounded-lg shadow-md flex flex-col items-center transform transition-all duration-300 hover:scale-105 hover:bg-primary-color" to={'/donation/form'}>
        ...
        <Link to={'/developers'} className="bg-gray-800 p-6 md:p-10 rounded-lg shadow-md flex flex-col items-center transform transition-all duration-300 hover:scale-105 hover:bg-primary-color">
        ...
        <Link to={'/contact'} className="bg-gray-800 p-6 md:p-10 rounded-lg shadow-md flex flex-col items-center transform transition-all duration-300 hover:scale-105 hover:bg-primary-color">
